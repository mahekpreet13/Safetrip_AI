...
// Fix Leaflet's default marker icons — Vite doesn't resolve these paths
// automatically like a plain webpack/CRA setup would, so without this fix
// markers render as broken image icons.
...
// Recenters the map whenever a search provides a new center
...
// Recenters the map ONCE, automatically, the first time the user's real
// location resolves — but only if they haven't already searched something
...
// A floating button that jumps back to the user's real location on demand
...
export default function CrimeMap({ center, markers = [], heatmapPoints = [] }) {
